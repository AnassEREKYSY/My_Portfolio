  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        intro: "Tell me briefly about the context and I will get back to you.",
        emailLabel: "Your email",
        emailPlaceholder: "you@company.com",
        emailRequired: "Please enter your email.",
        emailInvalid: "This email address does not look valid.",
        subjectLabel: "Subject",
        subjectPlaceholder: "Angular / .NET mission, 3 months",
        subjectRequired: "Please add a short subject.",
        messageLabel: "Message",
        messagePlaceholder: "Context, stack, timeline, and what you need help with.",
        messageRequired: "Please write a message.",
        messageTooShort: "A few more details would help (20 characters minimum).",
        send: "Send message",
        sending: "Sending...",
        sendAnother: "Send another",
        successTitle: "Message sent",
        successDesc: "Thanks, I will reply to you by email shortly.",
        errorTitle: "The message could not be sent",
        errorDesc: "Please try again, or write directly to ereanass@gmail.com.",
        privacy: "Your email is only used to reply to you.",
        notConfigured: "The form is not configured yet. Please use the email address above."
      }
    },
    howIWork: {
      title: "How I Work",
  ...
  fr: {
    ...
    contact: {
      ...
      form: {
        ...
        intro: "Décrivez brièvement le contexte, je vous réponds rapidement.",
        emailLabel: "Votre email",
        emailPlaceholder: "vous@entreprise.com",
        emailRequired: "Merci d'indiquer votre email.",
        emailInvalid: "Cette adresse email ne semble pas valide.",
        subjectLabel: "Objet",
        subjectPlaceholder: "Mission Angular / .NET, 3 mois",
        subjectRequired: "Merci d'ajouter un objet court.",
        messageLabel: "Message",
        messagePlaceholder: "Contexte, stack, délais, et le besoin sur lequel je peux aider.",
        messageRequired: "Merci d'écrire un message.",
        messageTooShort: "Quelques détails de plus seraient utiles (20 caractères minimum).",
        send: "Envoyer le message",
        sending: "Envoi...",
        sendAnother: "Envoyer un autre message",
        successTitle: "Message envoyé",
        successDesc: "Merci, je vous réponds par email très vite.",
        errorTitle: "L'envoi n'a pas fonctionné",
        errorDesc: "Réessayez, ou écrivez directement à ereanass@gmail.com.",
        privacy: "Votre email sert uniquement à vous répondre.",
        notConfigured: "Le formulaire n'est pas encore configuré. Utilisez l'adresse email ci-dessus."
      }
    },
    howIWork: {
